...
PROGNAME = CirnoIceFall

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o myLib.o images/bullet.o images/cirno.o images/splashScreen.o text.o font.o images/directionScreen.o images/loseScreen.o images/horzBullet.o images/creditScreen.o images/winScreen.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h images/bullet.h images/cirno.h images/splashScreen.h text.h images/directionScreen.h images/loseScreen.h images/horzBullet.h images/creditScreen.h images/winScreen.h
